...
fnPrepKeePass() {
    cd "${kpRoot}/KeePass" || exit
    kpCsProj="KeePass.csproj"
...
fnPrepKeePassLib() {
    cd "${kpRoot}/KeePassLib" || exit
    kpCsProj="KeePassLib.csproj"
    kpXmlUtilEx="Utility/XmlUtilEx.cs"
...
fnPrepTrlUtil() {
    cd "${kpRoot}/Translation/TrlUtil" || exit
    kpCsProj="TrlUtil.csproj"
